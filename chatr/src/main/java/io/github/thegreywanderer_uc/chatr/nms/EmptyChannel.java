...
/**
 * Empty Netty channel for NPC connections.
 * NPCs don't need actual network I/O, so this provides a no-op implementation.
 * Modeled after Citizens2's EmptyChannel.
 */
